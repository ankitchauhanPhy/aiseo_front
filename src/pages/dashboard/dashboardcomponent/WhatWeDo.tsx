...
const WhatWeDo = () => {
  return (
    <section className="relative bg-gradient-to-b from-white to-purple-50 py-20 px-6 md:px-16 ">
      ...
      <div className="relative z-10 max-w-full mx-auto flex flex-col items-center text-center">
        {/* Section Label */}
        ...
        {/* Title */}
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#311267]">What we do?</h2>

        <div className="flex flex-col lg:flex-row my-16 w-full gap-6 items-start">

          {/* Left Column: Big Number */}
          <div className=" flex flex-col justify-between h-full text-left w-[300px]">
            {/* Big Number at top */}
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <p className="text-gray-600 text-lg mb-4">
              LLM visibility is the new digital shelf where brands rush to get surfaced.
              AI Answer Engines are used by billions daily to shape perspectives, help
              make buying decisions and answer questions about your brand and industry.
              LLM visibility is the new digital shelf where brands rush to get surfaced.
            </p>
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap lg:flex-nowrap gap-6">
              ...
              <div className="flex-1 bg-white shadow-md rounded-xl p-6 text-center">
                ...
                <h3 className="font-semibold">Know your Rank</h3>
              ...
              <div className="flex-1 bg-white shadow-md rounded-xl p-6 text-center">
                ...
                <h3 className="font-semibold">Know your Mentions</h3>
                <p className="text-sm text-gray-500 mt-2">
                  LLM visibility is the new digital shelf where brands rush to get surfaced.
                </p>
              </div>
              ...
              <div className="flex-1 bg-white shadow-md rounded-xl p-6 text-center">
                ...
                <h3 className="font-semibold">Get Suggestions</h3>
                <p className="text-sm text-gray-500 mt-2">
                  LLM visibility is the new digital shelf where brands rush to get surfaced.
                </p>
              </div>
