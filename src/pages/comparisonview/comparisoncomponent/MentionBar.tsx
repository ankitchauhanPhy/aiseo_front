...
import MentionsChatgpt2 from "../../../assets/mainHistory/MentionChatgpt2.svg";
    ...
    <Card className="p-6 bg-white shadow-sm border border-gray-200 rounded-2xl">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Maximize2 className="w-5 h-5 text-gray-400 cursor-pointer hover:text-gray-600" /> */}
      ...
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:gap-4 ">
        <div className="text-5xl font-bold text-gray-900 mb-2">4387</div>
