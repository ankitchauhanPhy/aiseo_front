...
const VisibilityChart: React.FC<VisibilityProps> = ({ setOpenVisibility, setVisibilityData }) => {
  ...
  return (
    <Card className="w-full bg-white relative lg:h-[40%] h-[50%]">
      ...
      <CardContent>
        <BarMain setOpenVisibility={setOpenVisibility} setVisibilityData={setVisibilityData}/>
      </CardContent>
    </Card>
  )
}
