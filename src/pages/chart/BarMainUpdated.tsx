...
import BarChartUpdated from "./BarCharUpdated";
...
const  BarMainUpdated:React.FC<VisibilityProps> =({ setOpenVisibility, setVisibilityData })=> {
  ...
  return (
    ...
    //   <div className="flex-1 w-full">
        ...
        <BarChartUpdated  setOpenVisibility={setOpenVisibility} setVisibilityData={setVisibilityData}/>
        </>
    //   </div>
    // </div>
  );
